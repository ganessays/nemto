...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{url('login')}}" class="logo">
            ...
            <span class="logo-lg"><b>United</b>Form</span>
        </a>
                ...
                <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    <li><!-- start notification -->
                                        <a href="{{url('admin/list-registration')}}">
                                            <i class="fa fa-users text-aqua"></i> Registration
                                        </a>
                                    </li>
                                    <!-- end notification -->
                                </ul>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="{{url('public/avatar04.png')}}" class="user-image" alt="User Image">
                            <!-- hidden-xs hides the username on small devices so only the image appears. -->
                            <span class="hidden-xs">jj</span>
                        </a>
                        <ul class="dropdown-menu">
