...
@section('body')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="{{url('admin/list-speakers')}}"><i class="fa fa-calendar-times-o"></i> Co-Chair Listing</a></li>
                <li class="active">Create New Co-Chair</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">New Co-Chair</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="image">Co-Chair Image</label>
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <i>image upload size only 100 X 100 px</i>
                                ...
                                <div class="col-md-12">
                                    <div class="box box-info">
                                        <div class="box-header">
                                            <h3 class="box-title">Co-Chair Details
                                            </h3>
                                        </div>
                                        <!-- /.box-header -->
