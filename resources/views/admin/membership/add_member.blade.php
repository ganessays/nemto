...
@section('body')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="{{url('admin/list-registration')}}"><i class="fa fa-calendar-times-o"></i> Member Listing</a></li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            ...
                            <h3 class="box-title pull-right"><a href="{{url('admin/list-membership')}}" class="btn btn-primary btn-xs">Event Listing</a> <a href="{{url('admin/create-member')}}" class="btn btn-success btn-xs">Create New Member</a></h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
