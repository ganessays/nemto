                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('public/uploads/events/pdf').'/'.$event->overview_Pdf}}"> <i class="fa fa-file-pdf-o"></i></a>
                                        </td>
                                        <td>{{$event->name}}</td>
                                        ...
                                        <td>
                                            @if($event->status == 'active')
                                                <form action="{{url('admin/list-events/'.$event->id.'/updateEvents')}}" method="post">
                                                    {{csrf_field()}}
