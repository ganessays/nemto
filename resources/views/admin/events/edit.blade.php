                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>Meeting Overview in Only Pdf</label>
                                                </div>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <input type="file" name="overview_Pdf" value="{{$event->overview_Pdf}}" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="status" id="status" class="form-control">
                                                        <option value="active" @if($event->status == 'active') selected @endif>Publish</option>
                                                        <option value="inactive" @if($event->status == 'inactive') selected @endif>Draft</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="district_id" class="form-control select2" style="width: 100%;">
                                                        @foreach($country as $Countries)
                                                            <option value="{{$Countries->id}}" @if($Countries->id ==$Countries->country_id) selected @endif>{{$Countries->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>From</label>
                                                    <input type="date" value="{{$event->start_at}}" name="start_at" class="form-control" placeholder="Event Start Date">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>To</label>
                                                    <input type="date" value="{{$event->end_at}}" name="end_at" class="form-control" placeholder="Event End Date">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
