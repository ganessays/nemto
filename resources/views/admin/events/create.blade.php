...
@section('body')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="{{url('admin/list-events')}}"><i class="fa fa-calendar-times-o"></i> Event Listing</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <input type="file" name="overview_Pdf" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>From</label>
                                                <input type="date" name="start_at" class="form-control" placeholder="Event Start Date">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>To</label>
                                                <input type="date" name="end_at" class="form-control" placeholder="Event End Date">
                                            </div>
                                        </div>
                                    </div>
                                </div>
